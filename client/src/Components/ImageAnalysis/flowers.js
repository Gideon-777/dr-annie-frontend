...
class covid_chest extends React.Component {
    ...
    async classify() {
        ...
        .post(" http://127.0.0.1:5000/api/v1/flower", fd, {
            headers: {
              "Access-Control-Allow-Origin": "*",
              "Content-Type": "multipart/form-data",
            },
    ...
    render() {
        return (
            ...
            />}
                ...
                <h1 style={{ color: '#000000' }}>VEUILLEZ SÉLECTIONNER UNE IMAGE</h1>
                <h3 style={{ color: '#000000' }}>Classification des plantes à partir de l’intelligence artificielle</h3>
                ...
                <div className='column-wrapper'>
                    ...
                    <div className='column'>
                        ...
                        <h5>Classification à l’aide de l’intelligence artificielle</h5>
...
export default withRouter(covid_chest);
