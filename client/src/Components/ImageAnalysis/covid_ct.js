...
class ImageClassifier extends React.Component {
    ...
    async classify() {
        ...
        .post(" http://127.0.0.1:5000/api/v1/ct_detection", fd, {
            headers: {
              "Access-Control-Allow-Origin": "*",
              "Content-Type": "multipart/form-data",
            },
    ...
    render() {
        return (
            ...
            />}
                ...
                <h3 style={{ color: '#000000' }}>Detection de la COVID19 à partir de l’intelligence artificielle</h3>
                ...
                <div className='column-wrapper'>
                    <div className='column'>
                        ...
                        {this.state.images.map((img, i) => {
                            return <img className='img-preview' key={img.src} style={{ height: 200, width: 200 }} src={img.src}></img>
                        })}
                    </div>
                    <div>
                        ...
                        <div className='result-wrapper'>
                                ...
                                {this.state.predicted ?
                                        ...
                                        {this.state.predicted.map(img => (
                                            <div>
                                                <img className='img-preview' key={img.path} style={{ height: 200, width: 200 }} src={img.path}></img>
