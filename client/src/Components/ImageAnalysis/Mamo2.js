...
class Ct extends React.Component {
    ...
    async loadComponent() {
        try {
            this.model = await tf.loadLayersModel('http://127.0.0.1:5000/Sein01/model.json');
        } catch (e) {
    ...
    render() {
        return (
            ...
            <div>
              <strong>
                <h1 style={{ color: '#000000' }}>VEUILLEZ SÉLECTIONNER LES IMAGES À DIAGNOSTIQUER (CANCER DU SEIN - DETCETION DE LA REGION INFECTEE)</h1>
              </strong>
