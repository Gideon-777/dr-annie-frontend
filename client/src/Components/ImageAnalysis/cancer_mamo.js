    ...
    render() {
        return (
            ...
            />}
                ...
                <h3 style={{ color: '#000000' }} >Résultats d’une mammographie : La classification ACR à partir de l’intelligence artificielle</h3>
                <div className='center-content'>
                    <div className='button-container center-content'>
                        ...
                        <button
                            ...
                            className="actionButton predict" onClick={this.predictAll}
                        >
                            <i style={{ marginRight: 5 }} class="fa fa-binoculars" aria-hidden="true"></i>
                            <span>Scan</span>
                        </button>
                        <button
                            disabled={this.state.images.length === 0}
                ...
                <div className='column-wrapper'>
                    ...
                    <div className='column'>
                        ...
                        <h5>Détection de la zone infectée à l’aide de l’intelligence artificielle</h5>
                        <div className='result-wrapper'>

                                {this.state.detected ?
                                        <div>
                                        {this.state.detected.map(img => (
