...
class ImageClassifier extends React.Component {
    ...
    async classify() {
        ...
        .post(" http://127.0.0.1:5000/api/v1/wildfire", fd, {
            headers: {
              "Access-Control-Allow-Origin": "*",
              "Content-Type": "multipart/form-data",
            },
    ...
    render() {
        return (
            ...
            />}
                ...
                <h1 style={{ color: '#000000' }}>OZO WILDFIRE ANALYSIS</h1>
                <h3 style={{ color: '#000000' }}>AI based wildfire detection system</h3>
                ...
                <div className='column-wrapper'>
                    <div className='column'>
                        <h3 style={{ color: '#000000' }}>Original Image</h3>
                        <h5>You can select up to 5 images</h5>
